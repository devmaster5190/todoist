...
describe("<AddTask />", () => {
  ...
  describe("Success", () => {
    ...
    it("renders the <AddTask /> task date overlay when keydown", () => {
      const { queryByTestId } = render(<AddTask showAddTaskMain />)
    ...
    it("hides the <AddTask /> main when cancel keydown", () => {
      const { queryByTestId } = render(<AddTask showAddTaskMain />)
    ...
    it("renders <AddTask /> for quick add task and clicks cancel", () => {
    ...
    it("renders <AddTask /> for quick add task and the keydown cancel", () => {
      const showQuickAddTask = true
      const setShowQuickAddTask = jest.fn(() => !showQuickAddTask)
    ...
    it("renders <AddTask /> and adds a task with a task date", () => {
      ...
      fireEvent.change(queryByTestId("add-task-content"), {
        target: {
          value: "I am the most amazing ever!"
        }
      })
      expect(queryByTestId("add-task-content").value).toBe(
        "I am the most amazing ever!"
      )
